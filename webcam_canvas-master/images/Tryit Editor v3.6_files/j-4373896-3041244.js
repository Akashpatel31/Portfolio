...
(function(){
  var o = {
    ...
    (function() {
        var p = "4373896", n = JSON.parse('[]'), w = window, f = function(s) {
    ...
    var data = {
        params:window.ftParams_4373896||'',
        GUID:window.ftGUID_4373896||'99999999999',
        confID:window.ftConfID_4373896||'0',
        ftReturn: window.ftReturn_4373896||'',
        keyword:window.ftKeyword_4373896||'',
        ftId:window.ftId_4373896||'',
        imp:window.ftImp4373896,
        ftImpId:window.ftImp4373896 && window.ftImp4373896.impID || '',
        campaignID:'115749',
        cID:'122595',
        pID:'4373896',
        creativeID:'3041244',
        exttrack:[],
        extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115749&sid=18300&plc=4373896&num=&adid=&advid=&adsrv=29&btreg=4373896&btadsrv=flashtalking&crt=3041244&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"],
        clickTags: ["http://servedby.flashtalking.com/click/8/115749;4373896;3041244;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://acrobat.adobe.com/ca/en/free-trial-download.html?sdid=7RZ367W3&mv=display"],
        placementDescription:'VerizonFY20AcrobatRTRAcrobatSiteVisitorsCADSKBAN728x90',
        width:728,
        height:90,
        ...
        divID:'ftdiv4373896',
        phID:'ftpos4373896',
        frameID:'ftframe4373896',
        expID:'ftexpframe4373896',
        altImgID:'ftalt4373896',
        altText:'Click here',
        altImgTarget:'_blank',
        altimghref:'http://servedby.flashtalking.com/click/8/115749;4373896;3041244;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://acrobat.adobe.com/ca/en/free-trial-download.html?sdid=7RZ367W3&mv=display',
        altImg:'http://servedby.flashtalking.com/imp/8/115749;4373896;204;gif;Verizon;VerizonFY20AcrobatRTRAcrobatSiteVisitorsCADSKBAN728x90/?',
        viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/115749;4373896;271;pixel;Verizon;VerizonFY20AcrobatRTRAcrobatSiteVisitorsCADSKBAN728x90/?',
        stump:'http://servedby.flashtalking.com',
        jsurl:'http://cdn.flashtalking.com/xre/437/4373896/3041244/js/j-4373896-3041244.js',
        file:'http://cdn.flashtalking.com/122595/3041244/index.html',
        safeFrame: window.$sf && window.$sf.ext || false,
        serveDOM:'http://cdn.flashtalking.com',
        statBaseURL:'http://stat.flashtalking.com/reportV3/ft.stat?178987577-4373896;3041244;',
        adVis:false ? 1 : 0,
        centreAd:true,
        mvt:true,
        segment:window.ftSegment_4373896||'',
        segmentList:window.ftSegmentList_4373896||[],
        ...
        baggyFrameLimit:15,
        append:!!(window.ftImp4373896 && window.ftImp4373896.jsAppend),
        ...
        pageVisible: 'maybe',
        altimgborder: '0',
        secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m4373896')&&/^https:/.test(document.getElementById('ftscript_m4373896').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
        scriptLocation: document.getElementById('ftscript_m4373896'),
        ...
        qsVars:[
            ['ftguid', 'ftGUID_4373896'],
            ['ftcfid', 'ftConfID_4373896'],
            ['fttime', 'ftTimestamp_4373896'],
            ['ftsection', 'ftSection_4373896'],
            ['ftcustom', 'ftCustom_4373896'],
            ['ft_id', 'ftId_4373896'],
            ['ftimpid','ftImp4373896', 'impID']
        ]
    };
